...
export class MailService {
  async sendVerificationEmail(email: string, code: string) {
    ...
    await sgMail.send({
      ...
      subject: 'Verifica tu correo - Lacito',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa;">
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
            ...
            <div style="padding: 30px 40px;">
              <h2 style="color: #333; font-size: 20px; margin: 0 0 20px 0; text-align: center;">Verifica tu correo</h2>
              ...
              <p style="color: #555; font-size: 15px; line-height: 1.6; margin: 0 0 25px 0;">
                Gracias por registrarte. Utiliza el siguiente código para verificar tu correo electrónico:
              </p>
